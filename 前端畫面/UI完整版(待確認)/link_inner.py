...
def fix_file(filename, is_mom):
    ...
    mom_btn = '<button onclick="window.location.href=\'index.html\'" class="px-4 py-1.5 rounded-full bg-white text-primary shadow-sm">媽媽</button>' if is_mom else '<button onclick="window.location.href=\'index.html\'" class="px-4 py-1.5 rounded-full text-on-surface-variant">媽媽</button>'
